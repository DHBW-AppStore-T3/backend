...
async def lti13_login(
    ...
    if client_id and client_id != settings.LTI13_CLIENT_ID:
        logger.warning("LTI 1.3 login: client_id %r != configured %r", client_id, settings.LTI13_CLIENT_ID)
    ...
    auth_url = f"{settings.LTI13_PLATFORM_ISSUER}/mod/lti/auth.php?" + urllib.parse.urlencode(auth_params)
